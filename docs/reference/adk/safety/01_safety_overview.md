...
Table of contents 
  ...
  * Best practices 
  ...
  1. [ Run Agents  ](https://google.github.io/adk-docs/runtime/)
  2. [ Safety and Security  ](https://google.github.io/adk-docs/safety/)

[ ](https://github.com/google/adk-docs/edit/main/docs/safety/index.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/safety/index.md "View Markdown source")
...
[Google Cloud Vertex AI](https://cloud.google.com/vertex-ai/generative-ai/docs/overview) provides a multi-layered approach to mitigate these risks, enabling you to build powerful _and_ trustworthy agents. It offers several mechanisms to establish strict boundaries, ensuring agents only perform actions you've explicitly allowed:
  ...
  2. **Guardrails to screen inputs and outputs:** Control your model and tool calls precisely.
     ...
     * _Callbacks and Plugins:_ Validate model and tool calls before or after execution, checking parameters against agent state or external policies.
...
Some examples include:
  ...
  * **PII Redaction Plugin** : A specialized plugin with design for the [Before Tool Callback](https://google.github.io/adk-docs/plugins/#tool-callbacks) and specifically created to redact personally identifiable information before it’s processed by a tool or sent to an external service.
