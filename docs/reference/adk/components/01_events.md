...
Table of contents 
  ...
  * Best Practices for Working with Events 
  ...
  2. [ Events  ](https://google.github.io/adk-docs/events/)
...
PythonGoJava
[code]     calls = event.get_function_calls()
    if calls:
        for call in calls:
            tool_name = call.name
...
[/code]
[code]     import com.google.genai.types.FunctionCall;
...
PythonGoJava
[code]     responses = event.get_function_responses()
    if responses:
...
[/code]
[code]     import com.google.genai.types.FunctionResponse;
    import com.google.common.collect.ImmutableList;
    import java.util.Map;
...
[code]    if event.actions and event.actions.state_delta:
...
[code]    if event.actions and event.actions.artifact_delta:
...
[code]     import com.google.adk.events.EventActions;
...
PythonGoJava
[code]     # Pseudocode: Handling final responses in application (Python)
    # full_response_text = ""
    # async for event in runner.run_async(...):
...
[/code]
[code]     // Pseudocode: Handling final responses in application (Go)
    import (
        "fmt"
        "strings"
        "google.golang.org/adk/session"
...
[/code]
[code]     // Pseudocode: Handling final responses in application (Java)
    import com.google.adk.events.Event;
    import com.google.genai.types.Content;
...
[code]        // Example Error Event (conceptual)
        {
          "author": "LLMAgent",
          "invocation_id": "e-err...",
          "content": null,
