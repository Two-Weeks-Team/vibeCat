...
Agent Engine 
      ...
      * GKE  [ GKE  ](https://google.github.io/adk-docs/deploy/gke/) Table of contents 
...
Table of contents 
  ...
  * Cleanup 
  ...
  2. [ Deployment  ](https://google.github.io/adk-docs/deploy/)
...
We can navigate to the external IP and interact with the agent via UI ![alt text](https://google.github.io/adk-docs/assets/agent-gke-deployment.png)
