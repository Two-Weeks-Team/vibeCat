# Part 1. Intro to streaming - Agent Development Kit (ADK)
...
Gemini Live API Toolkit 
      * Gemini Live API Toolkit development guide series  Gemini Live API Toolkit development guide series 
        * Part 1. Intro to streaming  [ Part 1. Intro to streaming  ](https://google.github.io/adk-docs/streaming/dev-guide/part1/) Table of contents 
...
Table of contents 
  ...
  * Summary 
  ...
  1. [ Components  ](https://google.github.io/adk-docs/get-started/about/)
  2. [ Gemini Live API Toolkit  ](https://google.github.io/adk-docs/streaming/)
  3. [ Gemini Live API Toolkit development guide series  ](https://google.github.io/adk-docs/streaming/dev-guide/part1/)
...
![ADK Gemini Live API Toolkit Demo](https://google.github.io/adk-docs/streaming/dev-guide/assets/bidi-demo-screen.png)
...
**Session Duration** | Audio-only: 15 min  
Audio+video: 2 min  
With [Part 4: Context Window Compression](https://google.github.io/adk-docs/streaming/dev-guide/part4/#live-api-context-window-compression): Unlimited | Both: 10 min  
With [Part 4: Context Window Compression](https://google.github.io/adk-docs/streaming/dev-guide/part4/#live-api-context-window-compression): Unlimited  
...
**Event Model** | ❌ Custom event structures and serialization | ✅ Unified event model with metadata (see [Part 3: Event Handling](https://google.github.io/adk-docs/streaming/dev-guide/part3/))  
**Async Event Processing Framework** | ❌ Manual async coordination and stream handling | ✅ `LiveRequestQueue`, `run_live()` async generator, automatic bidirectional flow coordination (see [Part 2](https://google.github.io/adk-docs/streaming/dev-guide/part2/) and [Part 3](https://google.github.io/adk-docs/streaming/dev-guide/part3/))  
...
ADK Gemini Live API Toolkit integrates Live API session into the ADK framework's application lifecycle. This integration creates a four-phase lifecycle that combines ADK's agent management with Live API's real-time streaming capabilities:
  ...
  * ADK Gemini Live API Toolkit initialization:
    ...
    * Create a [RunConfig](https://google.github.io/adk-docs/streaming/dev-guide/part4/) for configuring ADK Gemini Live API Toolkit
    * Create a [LiveRequestQueue](https://google.github.io/adk-docs/streaming/dev-guide/part2/) for sending user messages to the `Agent`
    * Start a [run_live()](https://google.github.io/adk-docs/streaming/dev-guide/part3/) event loop
...
[RunConfig](https://google.github.io/adk-docs/streaming/dev-guide/part4/) defines the streaming behavior for this specific session—which modalities to use (text or audio), whether to enable transcription, voice activity detection, proactivity, and other advanced features.
...
`RunConfig` is **session-specific** —each streaming session can have different configuration. For example, one user might prefer text-only responses while another uses voice mode. See [Part 4: Understanding RunConfig](https://google.github.io/adk-docs/streaming/dev-guide/part4/) for complete configuration options.
...
See [Part 2: Sending messages with LiveRequestQueue](https://google.github.io/adk-docs/streaming/dev-guide/part2/) for detailed API documentation.
...
See [Part 3: Event handling with run_live()](https://google.github.io/adk-docs/streaming/dev-guide/part3/) for comprehensive event handling patterns.
...
[Next: Part 2: Sending Messages with LiveRequestQueue](https://google.github.io/adk-docs/streaming/dev-guide/part2/) →
