# Part 5. Audio, Images, and Video - Agent Development Kit (ADK)
...
Gemini Live API Toolkit 
      * Gemini Live API Toolkit development guide series  Gemini Live API Toolkit development guide series 
        ...
        * Part 5. Audio, Images, and Video  [ Part 5. Audio, Images, and Video  ](https://google.github.io/adk-docs/streaming/dev-guide/part5/) Table of contents 
          * How to Use Audio 
            * Sending Audio Input 
...
[code]    const accumulatedText = cleanText + transcriptionText;
...
[code]    if (currentInputTranscriptionId == null) {
        // Create new bubble
    } else {
...
The available voices vary by model architecture. To verify which voices are available for your specific model: \- Check the [Gemini Live API documentation](https://ai.google.dev/gemini-api/docs/live-guide) for the complete list \- Test voice configurations in development before deploying to production \- If a voice is not supported, the Live API will return an error

**Half-cascade models** support these voices: \- Puck \- Charon \- Kore \- Fenrir \- Aoede \- Leda \- Orus \- Zephyr

**Native audio models** support an extended voice list that includes all half-cascade voices plus additional voices from the Text-to-Speech (TTS) service. For the complete list of voices supported by native audio models: \- See the [Gemini Live API documentation](https://ai.google.dev/gemini-api/docs/live-guide#available-voices) \- Or check the [Text-to-Speech voice list](https://cloud.google.com/text-to-speech/docs/voices) which native audio models also support
...
For complete RunConfig reference, see [Part 4: Understanding RunConfig](https://google.github.io/adk-docs/streaming/dev-guide/part4/).
...
[code]    User: "I'm planning a trip to Japan next month."
    Expected: Model offers suggestions, asks follow-up questions
    
[/code]

  2. **Test emotional response** : 
[code]    User: [frustrated tone] "This isn't working at all!"
...
← [Previous: Part 4: Understanding RunConfig](https://google.github.io/adk-docs/streaming/dev-guide/part4/)
