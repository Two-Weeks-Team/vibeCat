# Agent Runtime - Agent Development Kit (ADK)
...
Table of contents 
  ...
  * Technical reference 
  ...
  2. [ Agent Runtime  ](https://google.github.io/adk-docs/runtime/)

[ ](https://github.com/google/adk-docs/edit/main/docs/runtime/index.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/runtime/index.md "View Markdown source")
...
[ Use the Web Interface](https://google.github.io/adk-docs/runtime/web-interface/)
...
[ Use the Command Line](https://google.github.io/adk-docs/runtime/command-line/)
...
For more in-depth information on runtime configuration and behavior, see these pages:
  ...
  * **[Event Loop](https://google.github.io/adk-docs/runtime/event-loop/)** : Understand the core event loop that powers ADK, including the yield/pause/resume cycle.
  * **[Resume Agents](https://google.github.io/adk-docs/runtime/resume/)** : Learn how to resume agent execution from a previous state.
  * **[Runtime Config](https://google.github.io/adk-docs/runtime/runconfig/)** : Configure runtime behavior with RunConfig.
