# REST API - Agent Development Kit (ADK)

Source: https://google.github.io/adk-docs/api-reference/rest/
...
API Reference 
      ...
      * REST API  [ REST API  ](https://google.github.io/adk-docs/api-reference/rest/) Table of contents 
        * Endpoints 
          * /run 
          * /run_sse 
        * Objects 
...
Table of contents 
  ...
  * Objects 
  ...
  1. [ Reference  ](https://google.github.io/adk-docs/release-notes/)
  2. [ API Reference  ](https://google.github.io/adk-docs/api-reference/)

[ ](https://github.com/google/adk-docs/edit/main/docs/api-reference/rest/index.md "Edit this page on GitHub") [ ](https://github.com/google/adk-docs/raw/main/docs/api-reference/rest/index.md "View Markdown source")

# REST API Reference¶

This page provides a reference for the REST API provided by the ADK web server. For details on using the ADK REST API in practice, see [Use the API Server](https://google.github.io/adk-docs/runtime/api-server/).
