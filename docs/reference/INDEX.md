...
- `LINK_VALIDATION_REPORT.md`: latest source URL validation results

## Naming Convention

- Directories: lowercase + kebab-case
- Files: `NN_topic_name.md` (sortable numeric prefix)
- Official sources are stored first, and source URLs are recorded in the manifest

## Source of Truth

- `REFERENCE_SOURCES_MANIFEST.md` is the source of truth for local-file and source-URL mapping.
