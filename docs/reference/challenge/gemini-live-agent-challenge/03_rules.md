...
Source: https://geminiliveagentchallenge.devpost.com/rules
...
Join a hackathon ____

[ ![Devpost logo](https://d2dmyh35ffsxbl.cloudfront.net/assets/reimagine2/devpost-logo-mobile-f3aff76bfc0b6ada9bb4ddd773bfc534769ed793f962612804a1e84c305a5f94.svg) Devpost Participate in our public hackathons ](https://devpost.com/hackathons)

[ Hackathons __](https://devpost.com/hackathons) [ Projects __](https://devpost.com/software)

[ ![Devpost for Teams](https://d2dmyh35ffsxbl.cloudfront.net/assets/reimagine2/dft-logo-mobile-ab66dd5a4f4b2f045ad86d0e5f432dc85974c3d778b353d32213c24ca176484b.svg) Devpost for Teams Access your company's private hackathons ](https://devpost.team)

[ Login __](https://devpost.team)

Host a hackathon ____

[ ![Devpost](https://d2dmyh35ffsxbl.cloudfront.net/assets/reimagine2/devpost-logo-mobile-f3aff76bfc0b6ada9bb4ddd773bfc534769ed793f962612804a1e84c305a5f94.svg) Devpost Grow your developer ecosystem and promote your platform ](https://info.devpost.com/product/public-hackathons)

[ Host a public hackathon __](https://info.devpost.com/product/public-hackathons)

[ ![Devpost for Teams logo](https://d2dmyh35ffsxbl.cloudfront.net/assets/reimagine2/dft-logo-mobile-ab66dd5a4f4b2f045ad86d0e5f432dc85974c3d778b353d32213c24ca176484b.svg) Devpost for Teams Drive innovation, collaboration, and retention within your organization ](https://info.devpost.com/product/devpost-for-teams)

[ Host an internal hackathon __](https://info.devpost.com/product/devpost-for-teams)

By use case

[ AI hackathons __](https://info.devpost.com/product/ai-hackathons) [ Customer hackathons __](https://info.devpost.com/product/customer-hackathons) [ Employee hackathons __](https://info.devpost.com/product/devpost-for-teams) [ Public hackathons __](https://info.devpost.com/product/public-hackathons)

Resources ____

[ Blog  Insights into hackathon planning and participation  ](https://info.devpost.com/blog)

[ Customer stories  Inspiration from peers and other industry leaders  ](https://info.devpost.com/customer-stories)

[ Planning guides  Best practices for planning online and in-person hackathons  ](https://info.devpost.com/guides)

[ Webinars & events  Upcoming events and on-demand recordings  ](https://info.devpost.com/webinar-events)

[ Help desk  Common questions and support documentation  ](https://help.devpost.com/)
...
[Join hackathon](https://geminiliveagentchallenge.devpost.com/register?flow%5Bdata%5D%5Bchallenge_id%5D=28633&flow%5Bname%5D=register_for_challenge)

#  [![Gemini Live Agent Challenge](https://d112y698adiu2z.cloudfront.net/photos/production/challenge_photos/004/336/521/datas/full_width.png)](https://geminiliveagentchallenge.devpost.com/)

Descend

  * [Overview](https://geminiliveagentchallenge.devpost.com/)
  * [My projects](https://devpost.com/submit-to/28633-gemini-live-agent-challenge/manage/submissions)
  * [Participants (5831)](https://geminiliveagentchallenge.devpost.com/participants)
  * [Resources](https://geminiliveagentchallenge.devpost.com/resources)
  * [Rules](https://geminiliveagentchallenge.devpost.com/rules)
  * [Project gallery](https://geminiliveagentchallenge.devpost.com/project-gallery)
  * [Updates](https://geminiliveagentchallenge.devpost.com/updates)
  * [Discussions](https://geminiliveagentchallenge.devpost.com/forum_topics)
...
To be eligible to enter the Contest, you must: 
  ...
  1. be above the age of majority in the country, state, province or jurisdiction of residence (or at least twenty years old in Taiwan) at the time of entry; 
  2. not be a resident of Italy, Quebec, Crimea, Cuba, Iran, Syria, Democratic People’s Republic of Korea (North Korea), Sudan, Belarus, Russia and any other country designated by the United States Treasury's Office of Foreign Assets Control; 
  3. not be a person or entity under U.S. export controls or sanctions; 
  4. have access to the Internet as of February 16, 2026, and
  5. NOT be individuals or organizations that are employed by a government agency or institution.
  6. Contest is void in Italy, Quebec, Crimea, Cuba, Iran, Syria, North Korea, Sudan and where prohibited by law. Employees, interns, contractors, and official office-holders of Google, Devpost, Inc., or any organizations involved with the design, production, paid promotion, execution, or distribution of the Contest, and their parent companies, subsidiaries, affiliates, and their respective directors, officers, employees, advertising and promotion agencies, representatives, and agents or their immediate family or members of their household (“Contest Entities”), and members of the Contest Entities’ and their immediate families (parents, siblings, children, spouses, and life partners of each, regardless of where they live) and members of the households (whether related or not) of such employees, officers and directors are ineligible to participate in this Contest. Sponsor reserves the right to verify eligibility and to adjudicate on any dispute at any time. Persons who are (1) residents of US embargoed countries, (2) ordinarily resident in US embargoed countries, or (3) otherwise prohibited by applicable export controls and sanctions programs may not participate in this contest. In addition, individuals or organizations whose participation in the Contest would create, in the sole discretion of the Sponsor and/or Administrator, a real or apparent conflict of interest are ineligible to participate in this Contest. 
...
Obtain access to the submission portal. You must have a Devpost account to register for the Contest as they will administer the Contest. If you do not have a Devpost account already, you can sign up for a Devpost account at no cost from [geminiliveagentchallenge.devpost.com](https://geminiliveagentchallenge.devpost.com/geminiliveagentchallenge.devpost.com).
...
Live Agent Category | 
  ...
  * $10,000 in USD
  * $1,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account)
  * Virtual Coffee with a Google Team Member
  * Social Promo

|  1 |  All eligible submissions that enter in the Live Agents category and uses Gemini Live API or the use of ADK. The agents are hosted on Google Cloud.  
...
|  1 |  All eligible submissions that enter in the Creative Storyteller category and use Gemini's interleaved/mixed output capabilities. The agents are hosted on Google Cloud.  
...
|  1 |  All eligible submissions that are in the UI Navigator category and uses Gemini multimodal to interpret screenshots/screen recordings and output executable actions. The agents are hosted on Google Cloud.  
  
**Subcategory Winners**

**Winner** |  **Prize** |  **Quantity** |  **Eligible**  
---|---|---|---  
Best Multimodal Integration & User Experience  |  • $5,000 in USD • $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) |  1 |  Top scoring projects in that judging criteria  
Best Technical Execution & Agent Architecture |  • $5,000 in USD • $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) |  1 |  Top scoring projects in that judging criteria  
Best Innovation & Thought Leadership  |  • $5,000 in USD • $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) |  1 |  Top scoring projects in that judging criteria  
...
Grand Prize | 
  ...
  * $25,000 in USD
  * $3,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account)
  * Virtual Coffee with a Google Team Member
  * Social Promo
  * Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) ) (Value: $2,299 each)
...
Honorable Mentions |  • $2,000 in USD • $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) |  5 |  Runners up from all eligible submissions  
...
#### Connect
  ...
  * [ __ Twitter  ](https://twitter.com/devpost)
  * [ __ Discord  ](https://discord.com/invite/HP4BhW3hnp)
  * [ __ Facebook  ](https://www.facebook.com/devposthacks)
  * [ __ LinkedIn  ](https://www.linkedin.com/company/devpost/)
